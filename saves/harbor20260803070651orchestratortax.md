...
_Subagents get justified by time saved and parallel execution, but that's not_
_what matters most in long-running multi-agent work. Every token in the orchestrator's_
_context is competing for its attention, and the real value of a subagent is what it keeps_
_out of that context, not how fast it runs. I argue that subagents should be treated as a_
_tool for protecting the orchestrator's working memory, offloading reasoning it doesn't_
_need to hold onto. Doing this well means giving the orchestrator explicit ground rules for_
_when and how to delegate. This is exploratory work, built from one real incident, and it ends_
_with more open questions than settled answers._

16 July 2026

* * *

[![Photo of Rahul Garg](https://martinfowler.com/articles/orchestrator-tax/rahul-garg.jpg)](https://www.linkedin.com/in/techygarg/)
...
- [The Incident Was Not Really About Parallelism](https://martinfowler.com/articles/orchestrator-tax.html#TheIncidentWasNotReallyAboutParallelism)
- [The Costs Were Not All the Same](https://martinfowler.com/articles/orchestrator-tax.html#TheCostsWereNotAllTheSame)
- [The Scarce Resource Is the Orchestrator's Working Memory](https://martinfowler.com/articles/orchestrator-tax.html#TheScarceResourceIsTheOrchestratorsWorkingMemory)
- [Cognitive Locality Changes What Parallelism Is For](https://martinfowler.com/articles/orchestrator-tax.html#CognitiveLocalityChangesWhatParallelismIsFor)
- [Turning a Session into Standing Rules](https://martinfowler.com/articles/orchestrator-tax.html#TurningASessionIntoStandingRules)
- [The Next Mistake Would Have Been More Governance](https://martinfowler.com/articles/orchestrator-tax.html#TheNextMistakeWouldHaveBeenMoreGovernance)
- [Where This Leaves Me](https://martinfowler.com/articles/orchestrator-tax.html#WhereThisLeavesMe)
...
answer about _that_ session. So I stopped the coding work and asked the
...
_That was the moment I realized I had been treating two very different_
_kinds of cost as though they were the same. Tokens are spent once. Context_
_shapes every decision that follows. I wasn't simply looking at token_
_consumption anymore. I was looking at the quality of the orchestrator's_
_working memory._
...
That left me with a heuristic I now use more than the rule itself: _Before_
_adding a line to a standing instruction file, ask whether a reasonably_
_competent orchestrator would make the right decision once it knew the one_
_missing fact._
